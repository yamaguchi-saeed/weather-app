...
function Temperatureanddetails({
    ...
    return (
        <div>
            {/* It says sunney or rainy or cloudy. */}
            <div className="flex items-center justify-center ру-6 text-xl text-cyan-300">
                <p>{details}</p>
            </div>

            {/* Image of weather, temperature and other details. */}
            ...
            {/* Image, temperature, details end here */}
